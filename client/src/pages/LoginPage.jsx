    ...
    justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      className='border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
        ...
        {currState === "Sign up" && !isDataSubmitted &&(
          ...
          type="text" className='p-2 border border-gray-500 rounded-md focus:outline-nnone'
        ...
        {currState === "Sign up" && isDataSubmitted && (
          ...
          foxus:ring-2 focus:ring-indigo-500'placeholder='Provide a short bio...'required></textarea>
        )}
        <button type="submit" className='py-3 bg-gradient-to-r from-purple-400 to-violet-600 
        text-white rounded-md cursor-pointer'>{currState === "Sign up"? "Create Account":"Login Now"}</button>
